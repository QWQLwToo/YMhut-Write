  ...
  <div class="h-screen w-full bg-gray-100/80 dark:bg-gray-900/80 backdrop-blur-sm flex items-center justify-center select-none transition-colors duration-500">
    ...
    <div class="bg-white/90 dark:bg-gray-800/90 backdrop-blur-md w-[800px] h-[600px] rounded-3xl shadow-2xl p-8 flex flex-col relative overflow-hidden border border-gray-300/50 dark:border-gray-700/50 transition-all duration-500">
      ...
      <transition name="slide-fade" mode="out-in">
        <div :key="currentStep" class="flex-1 flex flex-col items-center justify-center text-center px-12">
          ...
          <div v-if="currentStep === 1">
            ...
            <h1 class="text-3xl font-bold text-gray-800 mb-4">欢迎使用 YMhut-Write</h1>
            <p class="text-gray-500 leading-relaxed">
              感谢您选择 YMhut-Write！这是一个专为“轻量级”打造的专业写作工具。<br>
            ...
            <transition name="slide-up" appear>
              <div>
                <div class="flex items-center justify-center gap-3 mb-8">
                  ...
                  <h2 class="text-3xl font-bold text-gray-800 dark:text-white transition-colors">存储配置</h2>
                </div>
                  ...
                  <transition name="slide-left" appear>
                    <div class="bg-gray-50 dark:bg-gray-700/50 p-6 rounded-xl border border-gray-200 dark:border-gray-600 transition-all hover:shadow-lg">
                      ...
                      <div class="flex gap-2">
                        ...
                        <button @click="choosePath('db')" class="px-6 py-3 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition-all shadow-md hover:shadow-lg hover:scale-105 active:scale-95 font-medium">选择</button>
                      </div>
                    </div>
                  </transition>
                  ...
                  <transition name="slide-left" appear :style="{ transitionDelay: '0.1s' }">
                    <div class="bg-gray-50 dark:bg-gray-700/50 p-6 rounded-xl border border-gray-200 dark:border-gray-600 transition-all hover:shadow-lg">
                      ...
                      <div class="flex gap-2">
                        ...
                        <button @click="choosePath('doc')" class="px-6 py-3 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition-all shadow-md hover:shadow-lg hover:scale-105 active:scale-95 font-medium">选择</button>
                      </div>
                    </div>
                  </transition>
                </div>
                  ...
                  <div class="flex items-center justify-between">
                    <div class="flex-1">
                      <div class="flex items-center gap-3 mb-2">
                        ...
                        <h3 class="text-xl font-bold text-gray-800 dark:text-white transition-colors">开机自动启动</h3>
                      </div>
                      <p class="text-sm text-gray-600 dark:text-gray-400 ml-9 transition-colors">跟随系统启动，随时记录灵感</p>
                    </div>
            ...
            <transition name="slide-up" appear>
              <div>
                <div class="flex items-center justify-center gap-3 mb-8">
                  ...
                  <h2 class="text-3xl font-bold text-gray-800 dark:text-white transition-colors">惯用写作习惯</h2>
                </div>
                <div class="grid grid-cols-2 gap-6 max-w-2xl mx-auto">
                  <transition name="scale-in" appear>
                    ...
                    >
                      ...
                      <h3 class="font-bold text-lg text-gray-800 dark:text-white mb-2 transition-colors">Markdown 模式</h3>
                      <p class="text-sm text-gray-600 dark:text-gray-400 transition-colors">适合结构化写作，支持丰富格式</p>
                  ...
                  <transition name="scale-in" appear :style="{ transitionDelay: '0.1s' }">
                    ...
                    >
                      <div class="text-5xl mb-4 group-hover:scale-110 transition-transform">📄</div>
                      <h3 class="font-bold text-lg text-gray-800 dark:text-white mb-2 transition-colors">纯文本模式</h3>
                      <p class="text-sm text-gray-600 dark:text-gray-400 transition-colors">极致简约，专注文字本身</p>
      ...
      <div class="mt-8 flex justify-between items-center">
        ...
        <button 
          @click="nextStep"
          class="px-10 py-3 bg-indigo-600 text-white rounded-xl hover:bg-indigo-700 transition-all shadow-lg hover:shadow-indigo-500/50 font-medium flex items-center gap-2 group hover:scale-105 active:scale-95"
        >
          {{ currentStep === 4 ? '完成设置' : '下一步' }}
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" class="group-hover:translate-x-1 transition-transform">
